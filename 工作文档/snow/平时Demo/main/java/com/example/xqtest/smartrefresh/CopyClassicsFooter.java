...
public class CopyClassicsFooter extends ClassicsAbstract<CopyClassicsFooter> implements RefreshFooter {
    ...
    public CopyClassicsFooter(Context context) {
        this(context, null);
    }

    public CopyClassicsFooter(Context context, AttributeSet attrs) {
