...
class FundFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        println("hepan FundFragment onCreate")
    }
    ...
    override fun onCreateView(
        ...
        view.findViewById<View>(R.id.tvFundTest).setOnClickListener {
           testFun()
        }
    ...
    private fun testFun(){
        ...
        println("hepan res = ${sb} ${sb.length} ")
    }
    ...
    override fun onResume() {
        super.onResume()
        println("hepan  FundFragment onResume")
    }

    override fun onPause() {
        super.onPause()
        println("hepan  FundFragment onPause")
