...
public class SNBBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private SNBNestedScrollView outsideView;
//    private SNBNestedRecycleView snbNestedRecycleView;
    ...
    public void setOutsideView(SNBNestedScrollView outsideView) {
        this.outsideView = outsideView;
    }

//    public void setOutsideView(SNBNestedRecycleView outsideView) {
...
//    }
    ...
    private void scrollOutsideView(int dy) {
        if (outsideView != null && slideByOutsideView) {
            outsideView.setScrollByOutsideView(true);
            outsideView.scrollBy(0, dy);
        }
//        if (snbNestedRecycleView != null && slideByOutsideView) {
//            snbNestedRecycleView.setScrollOutsideView(true);
//            snbNestedRecycleView.scrollBy(0, dy);
//            snbNestedRecycleView.updateScrollBottomDy(dy);
//        }
    }
